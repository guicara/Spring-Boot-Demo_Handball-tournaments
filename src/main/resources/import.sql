...
-- MATCHS TABLE
DELETE FROM MATCHS;
INSERT INTO MATCHS(ID, ID_TEAM_HOME, ID_TEAM_AWAY, ID_SEASON, SCORE_HOME, SCORE_AWAY, PLAYED_AT) VALUES (1, 1, 2, 2, 23, 21, '2015-03-05 19:30:00.294');
INSERT INTO MATCHS(ID, ID_TEAM_HOME, ID_TEAM_AWAY, ID_SEASON, SCORE_HOME, SCORE_AWAY, PLAYED_AT) VALUES (2, 1, 3, 2, 10, 30, '2015-03-02 14:00:00.294');

-- RESULTS TABLE
DELETE FROM RESULTS;
INSERT INTO RESULTS(ID, ID_SEASON, ID_TEAM, PLAYED, WIN, DRAFT, LOSS) VALUES (1, 2, 1, 2, 1, 0, 1);
INSERT INTO RESULTS(ID, ID_SEASON, ID_TEAM, PLAYED, WIN, DRAFT, LOSS) VALUES (2, 2, 2, 1, 0, 0, 1);
INSERT INTO RESULTS(ID, ID_SEASON, ID_TEAM, PLAYED, WIN, DRAFT, LOSS) VALUES (3, 2, 3, 1, 1, 0, 0);

-- MATCHCOMMENTS TABLE
DELETE FROM MATCH_COMMENTS;
INSERT INTO MATCH_COMMENTS(ID, ID_USER, ID_MATCH, COMMENT, POSTED_AT) VALUES (1, 2, 1, 'What a beautiful match day! Lorem ipsum dolor sit amet, consectetur adipiscing elit.', '2015-03-06 11:20:10.294');
